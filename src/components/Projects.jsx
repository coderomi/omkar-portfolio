...
const Projects = () => {
  return (
    <div className='mx-auto max-w-6xl p-4 sm:p-10 text-white flex flex-col gap-10 sm:gap-10 items-center justify-center' id='projects'>
      ...
      <motion.div 
        ...
        {projectData.map((project) => (
          <a 
            ...
            <div className="flex flex-col gap-3 bg-green-900 p-5 transition-colors duration-300 hover:bg-gray-800 flex-grow">
